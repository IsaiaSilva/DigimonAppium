...
#Available finders are [:class, :class_name, :css, :id, :link, :link_text, :name, :partial_link_text, :tag_name, :xpath, :accessibility_id, 
#  :image, :custom, :uiautomator, :viewtag, :data_matcher, :view_matcher, :uiautomation, :predicate, :class_chain, :windows_uiautomation, :tizen_uiautomation]
end